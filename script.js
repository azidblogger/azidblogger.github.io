		...
		alamat: function (item, column) {
            ...
            simpleCart.ready(function () {
                simpleCart.bindOutlets({
                    total: function () {
                        return "<span id='totalharga' data-normal-harga='" + simpleCart.total() + "' data-harga='" + simpleCart.total() + "'>" + simpleCart.toCurrency(simpleCart.total()) + "</span>";
                    },
                    totalberat: function () {
